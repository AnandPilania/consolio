...
export async function initProject({ name = "My Project" } = {}) {
	...
	writeFileSync(
		join(consolioDir, ".gitignore"),
		`# consolio — commit collections & environments, ignore history\n.consolio/history/\n`,
	)
	...
	console.log("")
	console.log(
		chalk.cyan(`   Run ${chalk.white("npx consolio")} to start testing!`),
	)
}
